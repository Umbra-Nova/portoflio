...
export class PrestaShopBasePage {
  ...
  // PRESTO_BASE_URL =
  //   process.env.PRESTO_BASE_URL || 'https://prime-lip.demo.prestashop.com/';
  // PREST_REGISTRATION_URL =
  //   process.env.PREST_REGISTRATION_URL || `${this.PRESTO_BASE_URL}/registration`;
  // PREST_LOGIN_URL =
  //   process.env.PREST_LOGIN_URL || `${this.PRESTO_BASE_URL}/login`;

  // // Navigation
  // async navigateToHome(): Promise<void> {
  //   await this.page.goto(this.PRESTO_BASE_URL);
  //   await this.waitForPageReady();
  // }

  // async navigateToRegistration(): Promise<void> {
  //   await this.page.goto(this.PREST_REGISTRATION_URL);
  //   await this.waitForPageReady();
  // }

  // async navigateToLogin(): Promise<void> {
  //   await this.page.goto(this.PREST_LOGIN_URL);
  //   await this.waitForPageReady();
  // }
